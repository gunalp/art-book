...
class detailsVC: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if chosenPainting != "" {
            ...
            let fetchRequst = NSFetchRequest<NSFetchRequestResult>(entityName : "Paintings")
            
            
            fetchRequst.predicate = NSPredicate(format : "name = %@",self.chosenPainting)
        ...
        let gestureRecog = UITapGestureRecognizer(target : self, action : #selector(detailsVC.selectImage))
